...
const App = () => {
  ...
  useEffect(() => {
    function loadFont() {
      return new Promise((resolve, reject) => {
        ...
        link.rel = "stylesheet";
        link.href = "https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:opsz,wght,FILL,GRAD@20..48,100..300,0..1,-50..200";
        link.id = "google_font";
        link.onload = resolve(link);
      });
    };
    const fontPromise = loadFont();
    fontPromise.then((_link) => {
  ...
  return (
    data ? <ShoppingMart /> : <div className='loader'><div className='loader-box'><img className="loader" src={loader} alt="loader" /><div className='loading-txt'>Loading...</div></div></div>
  );
};
