...
const Category = () => {
  ...
  useEffect(() => {
    ...
    if (categoryBtn) {
      const activeBtn = categoryBtn.filter((ele) =>
        categoryFilter.includes(ele.id)
      );
      if (activeBtn) {
...
const Price = () => {
  ...
  useEffect(() => {
    if (priceBtn && priceRange !== null) {
      const activeBtn = priceBtn.filter(
        (ele) => ele.id === priceRange.toString()
      );
      if (activeBtn) {
  ...
  return (
    <div ref={price} onClick={handlePriceBtn}>
      <Button
        isLabel={false}
        label={currencyStatus ? "1-100" : "500-1000"}
        buttonType="filterButton"
      >
      ...
      <Button
        isLabel={false}
        label={currencyStatus ? "100-200" : "2000-3000"}
        buttonType="filterButton"
      >
        <Currency status={currencyStatus} />
      ...
      <Button
        isLabel={false}
        label={currencyStatus ? "200-500" : "3000-5000"}
        buttonType="filterButton"
      >
        <Currency status={currencyStatus} />
      ...
      <Button
        isLabel={false}
        label={currencyStatus ? "500-1000" : "5000-10000"}
        buttonType="filterButton"
      >
        <Currency status={currencyStatus} />
      ...
      <Button
        isLabel={false}
        label={currencyStatus ? "1000" : "10000"}
        buttonType="filterButton"
      >
        <Currency status={currencyStatus} />
